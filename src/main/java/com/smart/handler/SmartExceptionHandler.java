...
public class SmartExceptionHandler  {
    ...
    /**
     * Handle TokenExpiredException | AccessDeniedException | JWTDecodeException | InvalidSignatureException | SignatureVerificationException.
     *
     * @param ex
     * @param request
     * @return
    ...
    protected ResponseEntity<Object> handleJWTDecodeException(JWTDecodeException ex, WebRequest request) {
        return buildResponseEntity(new ApiError(HttpStatus.FORBIDDEN, ex.getMessage(), ex));
    }

    @ExceptionHandler(InvalidSignatureException.class)
    protected ResponseEntity<Object> handleInvalidSignature(InvalidSignatureException ex, WebRequest request) {
        return buildResponseEntity(new ApiError(HttpStatus.FORBIDDEN, ex.getMessage(), ex));
    }

    @ExceptionHandler(SignatureVerificationException.class)
    protected ResponseEntity<Object> handleSignatureVerificationException(SignatureVerificationException ex, WebRequest request) {
        return buildResponseEntity(new ApiError(HttpStatus.FORBIDDEN, ex.getMessage(), ex));
    }
